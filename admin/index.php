...
?>
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div style="width:20em;height:25em; background-color: transparent;position:fixed; top:4.5em; right: 10px; z-index: 1; padding:1.2em; overflow-x:auto;">

                    <?php
                     $sq_trans="SELECT * from `transactions` where `status`= 'new' order by `id` desc limit 5";
                                            ...
                                            while ($row=mysqli_fetch_array($rec,MYSQLI_BOTH)) 
                                            {
                                                ...
                                                $i++;
                                                 ...
                                                 echo "<div id='dlt' class='w3-container alert alert-slim w3-card-8 w3-yellow fade in'> 
                                                    <h1><a href=\"index.php\" class=\"close\" data-dismiss=\"alert\" aria-label=\"close\"> <img src='../images/icons/close.png' onclick=\"deleteNotifications('$notifId','notifications')\" title='close message'> </a> </h1>
                                                    <div style='text-align:center; align-self:center; font-size:14px'>
                                                    <strong>What Happened? </strong><br>  
                                                    <p class='pcontent'><strong>\"</strong>$description<strong>.\"</strong></p>
...
//delete notifications on realtime
    function deleteNotifications(str,opt) 
    {
        alert("hello obed");
